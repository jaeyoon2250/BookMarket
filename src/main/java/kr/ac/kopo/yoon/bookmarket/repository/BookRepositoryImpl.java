...
public class BookRepositoryImpl implements BookRepository{
    ...
    public BookRepositoryImpl() {
        ...
        book1.setBookName("해저2만리");
        book1.setBookPrice(new BigDecimal(17100));
        book1.setBookAuthor("쥘 베른");
        book1.setBookInfo("1866년, 언제부터인가 정체불명의 거대한 물체가 세계 곳곳의 바다에서 기괴한 해난 사고를 일으키고 있다는 소문이 미국과 유럽 등지에 떠돌게 되었습니다. 여러 척의 기선이 대양 한가운데서 정체를 알 수 없는 괴물과 부딪쳤고, 해양학자인 아로낙스 박사는 그 괴물이 지금까지 밝혀지지 않은 엄청난 크기의 고래 같다고 하며, " +
        ...
        book1.setBookPublisher("비룡소");
        book1.setCategory("소설");
        book1.setUnitsInStock(5);
        book1.setReleaseDate("2011-02-10");
        book1.setBookCondition("신규상품");

        Book book2 = new Book();
        book2.setBookId("isbn1002");
        book2.setBookName("데이터베이스 개론");
        book2.setBookPrice(new BigDecimal(29000));
        book2.setBookAuthor("김연희");
        book2.setBookInfo("데이터베이스로 첫 항해를 떠나는 이들에게 지도와 돛이 되어주는 책입니다.\n" +
        ...
        book2.setBookPublisher("한빛아카데미");
        book2.setCategory("컴퓨터/IT");
        book2.setUnitsInStock(5);
        book2.setReleaseDate("2022-01-15");
        book2.setBookCondition("신규상품");

        Book book3 = new Book();
        book3.setBookId("isbn1003");
        book3.setBookName("리눅스마스터 2급 한권으로 끝내기");
        book3.setBookPrice(new BigDecimal(23400));
        book3.setBookAuthor("박성업");
        book3.setBookInfo("이 책은 국가공인 리눅스마스터 2급 자격시험을 대비하기 위한 수험서이다. 최근 5년간 출제 기준을 반영하여 시험에 반드시 나오는 핵심 이론을 총 3개 파트, 12개 챕터, 29개 섹션으로 정리하였다. " +
